...
const isCurrentWeekDay = ({byweekday}, currentWeekDay) =>
				...
				{daysOfWeekArray.map((dayOfWeek, index) => (
					<Button
						className={classNames({
							[classes.button]: true,
							[classes.selectedButton]: isCurrentWeekDay(
								recurrenceOptions,
								dayOfWeek,
							),
						})}
...
export const WeeklyRecurrenceSelector = withStyles(styles)(WeeklyRecurrenceSelectorBase, {
